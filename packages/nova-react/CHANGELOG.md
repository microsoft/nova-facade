...
- Restore declaration files in published packages (stwilczy@microsoft.com)
...
- Add additional react version (kerryn@zyridium.net)
...
- fix hook (carmenberndt@microsoft.com)
